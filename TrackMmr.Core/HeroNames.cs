...
public static class HeroNames
{
    ...
    public static string Get(int heroId) =>
        Heroes.TryGetValue(heroId, out var name) ? name : $"Hero#{heroId}";

    public static string GetIconUrl(int heroId)
    {
        var internalName = GetInternalName(heroId);
        return $"https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/{internalName}.png";
    }

    private static string GetInternalName(int heroId)
    {
